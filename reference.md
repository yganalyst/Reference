...
https://zetawiki.com/wiki/%ED%8C%8C%EC%9D%B4%EC%8D%AC_join()  
-> 문자열 관련함수 Join()  
...
-> ValueError: invalid literal for int() with base 10: 파이썬 에러 정보  
  
http://mwultong.blogspot.com/2007/04/python-file-size-in-bytes.html   
-> os.path.getsize() 파일크기  
